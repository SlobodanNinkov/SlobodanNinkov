...
* Sensor networks and edge devices at scale  
* Real-time data pipelines and anomaly detection  
* Simulation and digital twins that reduce costly field testing  
* System integration across hardware, software, and operations  
...
* Prefer small teams with clear ownership over process-heavy coordination  
...
* Simulation, IoT, real-time systems, sensor fusion  
