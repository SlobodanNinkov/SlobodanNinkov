...
title: Few Lessons from a failed startup
...
Context: I tried to build a startup based on “simulated field usage and testing”. The need is real: in product development with field testing, simulation can be far cheaper than running systems in the field. [Case Study: Simulation-First Validation](/articles/simulation-validation/)  
